...
function renewAllInfo(usocket, io) {
    try {
        ...
        // 打印错误信息和函数入参
        console.log(`renewAllInfo error: ${error.message}`, usocket, io);
        throw error;        
    }
}
...
function judgeIsGameOver(usocket, io) {
    try {
        ...
        // 打印错误信息和函数入参
        console.log(`judgeIsGameOver error: ${error.message}`, usocket, io);
        throw error;
    }
}
...
function moveToNextTurn(usocket, io) {
    try {
        ...
        // 打印错误信息和函数入参
        console.log(`moveToNextTurn error: ${error.message}`, usocket, io);
        throw error;
    }
}
...
function startGame(usocket/* { socket.id: { username, socket } } */, io) {
    try {
        ...
        // 打印错误信息和函数入参
        console.log(`startGame error: ${error.message}`, usocket, io);
        throw error;
    }
}
...
function playerAction(usocket/* { socket.id: { username, socket } } */, id, action, io) {
    try {
        ...
        // 打印错误信息和函数入参
        console.log(`playerAction error: ${error.message}`, usocket, id, action, io);
        throw error;
    }
}
...
function continueSteal(usocket/* { socket.id: { username, socket } } */, id, targetPlayerName, io) {
    try {
        ...
        // 打印错误信息和函数入参
        console.log(`continueSteal error: ${error.message}`, usocket, id, targetPlayerName, io);
        throw error;
    }
}
...
function stillContinueSteal(usocket/* { socket.id: { username, socket } } */, id, io) {
    try {
        ...
        // 打印错误信息和函数入参
        console.log(`stillContinueSteal error: ${error.message}`, usocket, id, io);
        throw error;
    }
}
...
function contineAssassinate(usocket/* { socket.id: { username, socket } } */, id, targetPlayerName, io) {
    try {
        ...
        // 打印错误信息和函数入参
        console.log(`contineAssassinate error: ${error.message}`, usocket, id, targetPlayerName, io);
        throw error;
    }
}
...
function stillContinueAssassinate(usocket/* { socket.id: { username, socket } } */, id, io) {
    try {
        ...
        // 打印错误信息和函数入参
        console.log(`stillContinueAssassinate error: ${error.message}`, usocket, id, io);
        throw error;
    }
}
...
function executeCoup(usocket/* { socket.id: { username, socket } } */, id, targetPlayerName, io) {
    try {
        ...
        // 打印错误信息和函数入参
        console.log(`executeCoup error: ${error.message}`, usocket, id, targetPlayerName, io);
        throw error;
    }
}
...
function executeForeignAid(usocket/* { socket.id: { username, socket } } */, io) {
    try {
        ...
        // 打印错误信息和函数入参
        console.log(`executeForeignAid error: ${error.message}`, usocket, io);
        throw error;    
    }
}
...
function executeTax(usocket/* { socket.id: { username, socket } } */, id, io) {
    try {
        ...
        // 打印错误信息和函数入参
        console.log(`executeTax error: ${error.message}`, usocket, id, io);
        throw error;
    }
}
...
function executeExchange(usocket/* { socket.id: { username, socket } } */, id, io) {
    try {
        ...
        // 打印错误信息和函数入参
        console.log(`executeExchange error: ${error.message}`, usocket, id, io);
        throw error;
    }
}
...
function executeSteal(usocket/* { socket.id: { username, socket } } */, id, io) {
    try {
        ...
        // 打印错误信息和函数入参
        console.log(`executeSteal error: ${error.message}`, usocket, id, io);
        throw error;
    }
}
...
function executeAssassinate(usocket/* { socket.id: { username, socket } } */, id, io) {
    try {
        ...
        // 打印错误信息和函数入参
        console.log(`executeAssassinate error: ${error.message}`, usocket, id, io);
        throw error;
    }
}
...
function exposeHandCards(usocket, id, cards, io) {
    try {
        ...
        // 打印错误信息和函数入参
        console.log(`exposeHandCards error: ${error.message}`, usocket, id, cards, io);
        throw error;
    }
}
...
function discardHandCards(usocket, id, cards, io) {
    try {
        ...
        // 打印错误信息和函数入参
        console.log(`discardHandCards error: ${error.message}`, usocket, id, cards, io);
        throw error;
    }
}
...
function handleCounterProcess(usocket/* { socket.id: { username, socket } } */, id, counter, action, io) {
    try {
        ...
        // 打印错误信息和函数入参
        console.log(`handleCounterProcess error: ${error.message}`, usocket, id, counter, action, io);
        throw error;
    }
}
...
function handleDoubtProcess(usocket, id, doubt, action, io) {
    try {
        ...
        // 打印错误信息和函数入参
        console.log(`handleDoubtProcess error: ${error.message}`, usocket, id, doubt, action, io);
        throw error;
    }
}
...
function handleBatchDoubtProcess(usocket, id, doubt, action, io) {
    try {
        ...
        // 打印错误信息和函数入参
        console.log(`handleBatchDoubtProcess error: ${error.message}`, usocket, id, doubt, action, io);
        throw error;
    }
}
...
function handleSelfCertificate(usocket, id, canSertificate, character, action, io) {
    try {
        ...
        // 打印错误信息和函数入参
        console.log(`handleSelfCertificate error: ${error.message}`, usocket, id, canSertificate, character, action, io);
        throw error;
    }
}
